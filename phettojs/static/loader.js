// Copyright 2017,2018 Leaning Technologies Ltd
var hSlot = 0;
var sSlot = null;
var cjStatus = "";
...
function writeContinuationFunction(func, args, first)
{
	...
	ret+=writeContinuationFunctionImpl(code, continuationBuffer, code.length, pc, first, vars)
	return ret;
}
...
function loadWeakClass(name, p, allowMissing, cl)
{
...
function cheerpjPromiseResolve(a, b)
{
	a.promise.done(b);
	return b;
}

function cheerpjPromiseResolveE(a, ex)
{
	var detailMessage = "";
...
function cheerpjCreateInstance(className, methodName)
{
	...
	threads[0].continuationStack.unshift({func:cheerpjPromiseResolve, args:{pc:0,f:cheerpjPromiseResolve,promise:promise}});
...
function cheerpjRunStaticMethod(t, className, methodName)
{
	...
	var promise = cheerpjPromiseAdapter();
	t.continuationStack.unshift({func:cheerpjPromiseResolve, args:{pc:0,f:cheerpjPromiseResolve,promise:promise}});
	if(t.state == "PAUSED")
		t.state = "READY";
	cheerpjSchedule();
	return promise;
...
// hashCode
Array.prototype.v1=Array.prototype.lFaiDW5mq86jc=cjArrayHashCode;

// notifyAll
Array.prototype.v6=Array.prototype.idauYifyAllVEV=cjArrayNotifyAll;

// equals
Array.prototype.v2=Array.prototype.gtarbSiXq_dJgKmWrc7nd=cjArrayEquals;

// toString
Array.prototype.v4=cjArrayToString;

Array.prototype.ifs = ["java/io/Serializable"]
...
Int8Array.prototype.v1=cjArrayHashCode;
Int16Array.prototype.v1=cjArrayHashCode;
Uint16Array.prototype.v1=cjArrayHashCode;
Int32Array.prototype.v1=cjArrayHashCode;
Float32Array.prototype.v1=cjArrayHashCode;
Float64Array.prototype.v1=cjArrayHashCode;
Int8Array.prototype.v2=cjArrayEquals;
Int16Array.prototype.v2=cjArrayEquals;
Uint16Array.prototype.v2=cjArrayEquals;
Int32Array.prototype.v2=cjArrayEquals;
Float32Array.prototype.v2=cjArrayEquals;
Float64Array.prototype.v2=cjArrayEquals;
Int8Array.prototype.v4=cjArrayToString;
Int16Array.prototype.v4=cjArrayToString;
Uint16Array.prototype.v4=cjArrayToString;
Int32Array.prototype.v4=cjArrayToString;
Float32Array.prototype.v4=cjArrayToString;
Float64Array.prototype.v4=cjArrayToString;
Int8Array.prototype.v6=cjArrayNotifyAll;
Int16Array.prototype.v6=cjArrayNotifyAll;
Uint16Array.prototype.v6=cjArrayNotifyAll;
Int32Array.prototype.v6=cjArrayNotifyAll;
Float32Array.prototype.v6=cjArrayNotifyAll;
Float64Array.prototype.v6=cjArrayNotifyAll;
...
CheerpJProcess.prototype.removeThread=function(t)
{
	...
	if(this.threads.length == 0)
	{
		if(this.endPromise)
		{
			...
			setTimeout(function() { p.done(t.retValue); }, 0);
		}
	}
}
				...
				if(i>0 && chosenThread.state == "PAUSED")
				{
					...
					if(threadIndex > 0)
					{
						...
						if(chosenThread.threadObj)
						{
							...
							threads[0].continuationStack.push({func:cjExitThread,args:chosenThread.threadObj});
							if(threads[0].state == "PAUSED")
								threads[0].state = "READY";
						}
						...
						if(chosenThread.linearStack)
							CheerpJFreeStack(chosenThread.linearStack);
...
function cjGetAppletOrObjectOrEmbedParams(elem)
{
	...
	var archive = elem.getAttribute("archive") || elem.getAttribute("java_archive");
	var code = null;
	if(isApplet || isEmbed)
	{
	...
	else if(isObject)
	{
		...
		if(classid && classid.startsWith("java:"))
		{
...
function cheerpjRewriteAndReplaceApplet(elem)
{
	...
	if(jarArchive)
	{
		...
		for(var i=0;i<archives.length;i++)
		{
			...
			if(archive.startsWith(hostPrefix))
	...
	return cheerpjCreateInstance("N3com11leaningtech7cheerpj19CheerpJAppletViewer", cjAppletViewerConstuctor).then(function(a) {
		...
		// startAppletN4java4lang6StringN4java4lang6StringIIN4java4lang6ObjectN4java4lang6ObjectEV
		return cheerpjRunMethod(0, a, "v529", appletClass, loc, cjLocation.href, null, computedWidth, computedHeight, newObj, appletParameters);
	});
}
...
{
	if(window.hasOwnProperty("cjLoaderInjected"))
	{
...
function cjGetClassName(funcName)
{
	if(funcName[0] == '_')
	{
		...
		try
		{
			funcName = cheerpjDecompressSymbol(funcName);
		}
		catch(e)
		{
			// TODO: Refine this logic
			funcName = cheerpjDecompressSymbol(funcName.substr(0, funcName.length-1));
		}
	}
...
function cjG(a)
{
	...
	if(cinit===undefined)
	{
		...
		loadWeakClass(mangledClassName, a, false, cl);
...
function cheerpjPreload()
{
	if(cheerpjPreloadResources == null)
		return;
	while(cheerpjPreloadCount < 3)
	{
		if(cheerpjPreloadResources.length == 0)
		{
			cheerpjPreloadResources = null;
			return;
		}
